...
export const SET_NET_WORTH_DAILY = 'SET_NET_WORTH_DAILY';
export const SET_SP500_BENCHMARK = 'SET_SP500_BENCHMARK';
...
export const RESET_ALL_ACCOUNTS_TRANSACTIONS = 'RESET_ALL_ACCOUNTS_TRANSACTIONS';
